...
export default function Settings() {
  const [activeTab, setActiveTab] = useState<'economics' | 'manual' | 'api' | 'rules'>('economics');
    ...
    <div className="space-y-8 font-sans max-w-7xl pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">
            Setup JazzCash & Easypaisa Auto-Verify APIs, Manual Accounts, Stripe, and Coin exchange pricing.
          </p>
        </div>
      ...
      {saveSuccess && (
        <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-bold flex items-center gap-2 animate-in fade-in duration-200">
          ...
          All Payment Gateways, JazzCash/Easypaisa APIs, Manual Accounts & Pricing Settings saved successfully!
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-[#0f172a] border border-slate-800 p-5 rounded-2xl">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Active Automated APIs</span>
            <span className="text-[10px] font-bold text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded-full border border-blue-500/20">
              {activeApiCount} Auto-Verify
            </span>
          </div>
          <p className="text-2xl font-black text-blue-400 mt-2">{activeApiCount} / 4 Active</p>
          <p className="text-xs text-slate-400 mt-1">JazzCash API, Easypaisa API, Stripe, Binance</p>
        </div>
      ...
      <div className="flex border-b border-slate-800 gap-2 overflow-x-auto pb-1">
        ...
        >
          ...
          Manual Payment Accounts (Pakistan & Crypto)
        ...
        >
          ...
          Automated Auto-Verify APIs (JazzCash, Easypaisa, Stripe)
