...
export default function EarnerLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/earner/dashboard', icon: LayoutDashboard },
    { name: 'Network', href: '/earner/network', icon: Users },
    { name: 'Wallet', href: '/earner/wallet', icon: Wallet },
    { name: 'Settings', href: '/earner/settings', icon: Settings },
  ];
    ...
    <div className="min-h-screen bg-zinc-50 flex">
      ...
      <div className="w-64 bg-white border-r border-zinc-200 flex flex-col hidden md:flex">
        <div className="h-16 flex items-center px-6 border-b border-zinc-200">
          <Link href="/earner/dashboard" className="flex items-center gap-2 font-bold text-xl">
        ...
        <div className="p-4 border-t border-zinc-200">
          <div className="flex items-center gap-3 px-3 py-2 mb-2">
            ...
            <div className="overflow-hidden">
              <p className="text-sm font-medium text-zinc-900 truncate">Partner Account</p>
